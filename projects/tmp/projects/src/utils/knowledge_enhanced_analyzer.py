...
class KnowledgeEnhancedAnalyzer:
    ...
    def __init__(self, assets_path: str = "assets"):
        ...
        # 初始化知识学习引擎
        self.learner = KnowledgeLearner(assets_path)
        
        # 初始化知识应用引擎
        self.applier = None
        
        # 初始化原有分析器
        self.base_analyzer = KnowledgeBasedAnalyzer(assets_path)
    ...
    def get_learning_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'learning_stats': self.learner.learning_stats if self.is_learned else {},
            'knowledge_count': len(self.learner.knowledge_entries) if self.is_learned else 0,
            'book_source_count': len(self.learner.book_sources) if self.is_learned else 0,
            'pattern_count': len(self.learner.patterns) if self.is_learned else 0
        }
